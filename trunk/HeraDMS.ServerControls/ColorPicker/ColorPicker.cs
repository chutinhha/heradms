...
namespace HeraDMS.ServerControls
{
    ...
    public class ColorPicker : WebControl, IPostBackDataHandler
    {
        ...
        {            
            // Javascript
            string colorFunctions = Page.ClientScript.GetWebResourceUrl(typeof(ColorPicker), "HeraDMS.ServerControls.ColorPicker.ColorPicker.js");
...
PopupPosition : {8}
            ...
            ", ClientID
             , Page.ClientScript.GetWebResourceUrl(typeof(ColorPicker), "HeraDMS.ServerControls.ColorPicker.Images.SliderHandle.gif")
             , Page.ClientScript.GetWebResourceUrl(typeof(ColorPicker), "HeraDMS.ServerControls.ColorPicker.Images.TabRightActive.gif")
             , Page.ClientScript.GetWebResourceUrl(typeof(ColorPicker), "HeraDMS.ServerControls.ColorPicker.Images.TabRightInactive.gif")
             , Page.ClientScript.GetWebResourceUrl(typeof(ColorPicker), "HeraDMS.ServerControls.ColorPicker.Images.TabLeftActive.gif")
             , Page.ClientScript.GetWebResourceUrl(typeof(ColorPicker), "HeraDMS.ServerControls.ColorPicker.Images.TabLeftInactive.gif")             
        ...
        private void RegisterCSSInclude(Control target)
        {
            ...
            if (!linkIncluded)
            {
                ...
                csslink.Attributes.Add("href", Page.ClientScript.GetWebResourceUrl(typeof(ColorPicker), "HeraDMS.ServerControls.ColorPicker.ColorPicker.css"));
