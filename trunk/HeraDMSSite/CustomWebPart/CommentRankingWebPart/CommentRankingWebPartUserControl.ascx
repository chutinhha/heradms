...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CommentRankingWebPartUserControl.ascx.cs" Inherits="HeraDMS.CustomWebPart.CommentRankingWebPart.CommentRankingWebPartUserControl" %>
<div style="width:100%">
    <asp:GridView ID="gvCommentRanking" runat="server" Width="100%" 
        CellPadding="4"  ForeColor="#333333" 
        GridLines="None" style="margin-right: 0px" EmptyDataText="无数据或未加载" 
        AutoGenerateColumns="False" EnableModelValidation="True" 
        ShowHeader="False" onrowdatabound="gvCommentRanking_RowDataBound" >
