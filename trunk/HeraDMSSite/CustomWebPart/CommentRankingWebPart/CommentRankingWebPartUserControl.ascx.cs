...
namespace HeraDMS.CustomWebPart.CommentRankingWebPart
{
    public partial class CommentRankingWebPartUserControl : UserControl
    {
        CommentBLL CommentBLL = new CommentBLL();
        const int topCount = 10;
        protected void Page_Load(object sender, EventArgs e)
        {
            this.gvCommentRanking.Attributes.Add("style", "word-break:break-all;word-wrap:break-word");
            if (!IsPostBack)
            {
                BindData();
            }
        ...
        {
            this.gvCommentRanking.DataSource = CommentBLL.LoadCommentRanking(topCount);
            this.gvCommentRanking.DataBind();
        }
        ...
        /// <param name="e"></param>
        protected void gvCommentRanking_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowIndex >= 0)
            {
